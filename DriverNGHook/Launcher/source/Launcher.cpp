...
#define TARGET_DLL_NAME				"DriverNGHook.dll"
#define TARGET_EXE_NAME				"Driver.exe"
...
#ifdef LAUNCHER_DEBUG_MEMORY_ENABLED
...
int main(int, char**)
{
    /// NOTE: WORKING DIRECTORY MUST BE LOCATED NEAR Driver.exe!
    ...
    sprintf(pathToExeBuffer, "%s\\%s -offline", currentDirectoryBuffer, TARGET_EXE_NAME);
